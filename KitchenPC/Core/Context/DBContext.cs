namespace KitchenPC.Context
{
    ...
    public class DBContext : IKPCContext, IProvisionSource, IProvisionTarget
    {
        ...
        public virtual IModelerLoader ModelerLoader
        {
            get
            {
                return new DBModelerLoader(this.Adapter);
            }
        }
        ...
        {
            this.Adapter.DequeueRecipe(this.Identity, recipeIds);
        }
        ...
        {
            this.Adapter.EnqueueRecipes(this.Identity, recipeIds);
        }
        ...
        {
            return this.Adapter.GetRecipeQueue(this.Identity);
        }
        ...
        {
            this.Adapter.RateRecipe(this.Identity, recipeId, rating);
        }
        ...
        public RecipeResult CreateRecipe(Recipe recipe)
        {
            ...
            return this.Adapter.CreateRecipe(this.Identity, recipe);
        }
        ...
        {
            return this.Adapter.ReadFormsForIngredient(id);
        }
        ...
        {
            return this.Adapter.ReadIngredient(ingredient);
        }
        ...
        /// <returns>A KitchenPC Ingredient object, or null if no matching ingredient was found.</returns>
        public virtual Ingredient ReadIngredient(Guid ingredientId)
        {
            return this.Adapter.ReadIngredient(ingredientId);
        }
        ...
        {
            this.Adapter.DeleteMenus(this.Identity, menuIds);
        }
        ...
        {
            return this.Adapter.ExportStore();
        }
